...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [XChatTextView maxCharactersPerLine];
...
{
    return [XChatTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [XChatTextView maxCharactersPerLine]) + 1;
}
